...
#include </opt/Caliper-2.13.1/include/caliper/cali-manager.h>
#endif
...
int main(int argc, char **argv) {
  ...
  // Create an instance of the Caliper Manager
  // This seems to be the only way to call flush BEFORE MPI Finalize...
...
#pragma omp parallel
  ...
  // Trigger the mpireport service to run before MPI_Finalize.
  mgr.flush();
  adiak::fini();
#endif
  // Cleanup and exit
